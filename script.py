...
while True:
    ...
    # conf_thresh - threshold for when an object is labeled as its class - 0.6 means 60% confidence
    # exist_ok - whether the files from previous runs should be overwritten
    detect.run(source='snapshot.png', save_txt=True, classes=0, conf_thres=0.6, exist_ok=True)
